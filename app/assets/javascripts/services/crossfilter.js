...
angular.module('birdwatch.services').factory('cf', function (utils) {
    ...
    var cf = crossfilter([]);
    var timeDim = cf.dimension(function(t) { if(t.mstime==undefined){t.mstime = moment.utc(t.datetime+" +0800")._d.getTime();} return t.mstime; });
    ...
    function dateRound(s) { return function(t) { if(t.mstime==undefined){t.mstime = moment.utc(t.datetime+" +0800")._d.getTime();} return s * Math.floor(t.mstime / (s * 1000)) }; }
